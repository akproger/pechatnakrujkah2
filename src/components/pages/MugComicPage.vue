...
export default {
  ...
  methods: {
    ...
    createMaskGroup(mask) {
      ...
      // Добавляем обводку в группу, если она есть
      if (mask.strokePath) {
        console.log('🎨 [createMaskGroup] Добавляем обводку в группу')
        group.addChild(mask.strokePath)
        console.log('🎨 [createMaskGroup] Обводка добавлена в группу')
      } else {
        console.log('🎨 [createMaskGroup] Обводка не найдена')
      }
